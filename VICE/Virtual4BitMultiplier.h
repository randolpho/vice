...
namespace VICE
{
  ...
  {
    // The Virtual4BitMultiplier multiplies two 4-bit binary numbers.
    // The Virtual4BitMultiplier has 8 input VirtualConnections -- 
    // 4 for the multiplicand and 4 for the multiplier -- and output
    // VirtualConnections for the product along with a carry/overflow
    // output. 
    //
    // The 4-bit multiplicand (InputA) and multiplier (InputB) are 
    ...
    class Virtual4BitMultiplier : public VICE::Component::VirtualComponent
    {
    private:
      ////////////////////
      // sub-components //
      ////////////////////
      VICE::Memory::Virtual4BitRegister Multiplicand;
      VICE::Memory::Virtual4BitRegister Multiplier;
      VICE::Memory::Virtual4BitRegister Accumulator;
      VICE::Arithmetic::Virtual4BitAdderSubtractor Adder;
    ...
    private:
      ...
      //********************************************************************//
      //** A -- simulates the 4-bit multiplicand of 4-bit multiplier.     **//
    ...
    public:
      ...
      //********************************************************************//
      //** B -- simulates the 4-bit multiplier of a 4-bit multiplier.     **//
      //**   Each bit defaults to VirtualConnection::AlwaysOff            **//
      //********************************************************************//
    private:      
    ...
    public:
      ...
      //*******************************************************************//
      //** Product -- simulates the 8-bit product of a 4-bit multiplier. **//
      //**   Each bit defaults to VirtualConnection::AlwaysOff           **//
      //*******************************************************************//
    private:      
      const VICE::Component::VirtualConnection * Product[8];
    public:
      ...
      //***********************************************************************//
      //** OutputCarry  -- simulates the carry output of a 4-bit multiplier. **//
