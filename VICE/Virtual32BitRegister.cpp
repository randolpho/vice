...
Virtual32BitRegister::Virtual32BitRegister(void) : Shift(&VirtualConnection::AlwaysOff)
{
  for(int i=0; i<32; i++)
  {
...
void Virtual32BitRegister::Update()
{
...
#ifdef _DEBUG
void Virtual32BitRegister::UpdateWireState()
{
  for(int i=0; i<32; i++)
  {
...
//** Input **//
//***********//
const VirtualConnection * Virtual32BitRegister::Get_Input(int bit)
{
  if(bit < 0 || bit > 31)
  {
...
const VirtualConnection ** Virtual32BitRegister::Get_Input()
{
  return Input;
}
void Virtual32BitRegister::Set_Input(const VirtualConnection * input, int bit)
{
  if(input == NULL)
  {
...
void Virtual32BitRegister::Set_Input(const VirtualConnection * input)
{
  if(input == NULL)
  {
    throw std::invalid_argument("input cannot be null");
...
//** Control **//
//*************//
const VirtualConnection * Virtual32BitRegister::Get_Control(int bit)
{
  if(bit < 0 || bit > 1)
  {
...
const VirtualConnection ** Virtual32BitRegister::Get_Control()
{
  return Control;
}
void Virtual32BitRegister::Set_Control(const VirtualConnection * input, int bit)
{
  if(input == NULL)
  {
    throw std::invalid_argument("input cannot be null");
...
void Virtual32BitRegister::Set_Control(const VirtualConnection * input)
{
  if(input == NULL)
  {
    throw std::invalid_argument("input cannot be null");
...
//** Shift **//
//***********//
const VirtualConnection * Virtual32BitRegister::Get_Shift()
{
  return Shift;
}
void Virtual32BitRegister::Set_Shift(const VirtualConnection * input)
{
  if(input == NULL)
  {
    throw std::invalid_argument("input cannot be null");
  ...
  BitControl[31].Set_Input(input, 1);
}

//************//
//** Output **//
//************//
const VirtualConnection * Virtual32BitRegister::Get_Output(int bit)
{
  if(bit < 0 || bit > 31)
  {
    throw std::invalid_argument("bit must be between 0 and 31");
...
const VirtualConnection ** Virtual32BitRegister::Get_Output()
{
  return Output;
}