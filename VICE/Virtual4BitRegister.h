...
namespace VICE
{
  namespace Memory
  {
    // The Virtual4BitRegister implements a 4-bit universal (shift-left/shift-right
    ...
    // Virtual4BitRegister takes during update. The following truth table shows the
    ...
    class Virtual4BitRegister : public VICE::Component::VirtualComponent
    {
    private:
      ////////////////////
      // sub-components //
      ...
      VICE::Component::VirtualFlipFlop Bits[4];
      // input/action controllers
      VICE::Control::VirtualMultiplexer_4_1 BitControl[4];
      // inverts the output of BitControl; necessary because of the
      // way VirtualFlipFlops set bits. 
      VICE::Logic::VirtualInverter MuxInverters[4]; 
    public:
      /////////////
      // Methods //
      /////////////
    ...
    public:
      ...
      // returns the Input bits as an array of VirtualConnections (size 4)
      ...
      // sets the Input bits as an array of VirtualConnections (size 4)
    ...
    public:
      ...
      //*********************************************************//
      //** Output -- the 4-bit current value of the register   **//
      //**   Each bit defaults to VirtualConnection::AlwaysOff **//
      //*********************************************************//
    private:      
      const VICE::Component::VirtualConnection * Output[4];
    public:
